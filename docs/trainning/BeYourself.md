...
你可以拿这幅图作为参考。目前幻协的工作任务分配采用“抽卡式”。活动主要负责人在推进活动进度的过程中，将自己的工作拆分成更加具体的工作（如起草推文、设计海报、张贴海报、起草比赛规则等），将这些任务提交给调度中心，由调度中心根据干员等级信息进行尽可能随机、平均地工作分配。目前“调度中心”由社长和一个程序脚本完成，人类负责收发消息，脚本负责随机分配工作。如果你有将这个步骤完全自动化的灵感请联系社长。
